    ...
    <>
      <div className="bg-white">
        <div className={`${styles.OurTeamContainer} container mx-auto`}>
          <h2 className="text-center text-2xl pb-12 md:pb-24 ">
          ...
          <div className="flex md:p-0 p-4 flex-col mt-12 md:mt-24 md:items-end items-center">
            <div
              className={`${styles.LeftParent} flex px-12 pb-24 flex-col md:items-start items-center`}
            >
              <div>
                ...
                <div className="border-t-1 border-black w-[45px]"></div>
                <p className=" pt-3 text-sm">Managing Partner</p>
                <p className="text-sm pt-[2px] font-light">
                  {" "}
                  <a href="mailto:info@tasaarchitects.com">
                    info@tasaarchitects.com
